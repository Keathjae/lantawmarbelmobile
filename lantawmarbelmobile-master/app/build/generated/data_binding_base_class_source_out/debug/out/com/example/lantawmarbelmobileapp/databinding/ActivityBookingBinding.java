...
public final class ActivityBookingBinding implements ViewBinding {
  ...
  private ActivityBookingBinding(@NonNull LinearLayout rootView, @NonNull TabLayout tabLayout,
  ...
  public static ActivityBookingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityBookingBinding((LinearLayout) rootView, tabLayout, viewPager);
    }

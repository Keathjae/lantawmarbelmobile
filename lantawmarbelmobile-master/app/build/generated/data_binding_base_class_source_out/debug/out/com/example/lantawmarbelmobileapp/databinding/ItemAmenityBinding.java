...
public final class ItemAmenityBinding implements ViewBinding {
  @NonNull
  ...
  private ItemAmenityBinding(@NonNull CardView rootView, @NonNull TextView amenityAdultPrice,
  ...
  @NonNull
  public static ItemAmenityBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemAmenityBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_amenity, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemAmenityBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemAmenityBinding((CardView) rootView, amenityAdultPrice, amenityChildPrice,
          amenityDescription, amenityImage, amenityName);
    }

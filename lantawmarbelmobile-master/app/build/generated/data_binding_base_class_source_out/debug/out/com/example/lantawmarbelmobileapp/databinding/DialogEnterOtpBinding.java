...
public final class DialogEnterOtpBinding implements ViewBinding {
  ...
  private DialogEnterOtpBinding(@NonNull LinearLayout rootView, @NonNull TextInputEditText otpInput,
  ...
  @NonNull
  public static DialogEnterOtpBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DialogEnterOtpBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_enter_otp, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogEnterOtpBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogEnterOtpBinding((LinearLayout) rootView, otpInput, verifyButton);
    }
